        ...
        <div class="contenedor contenedor-grid">
            <div class="grid" id="grid">
                <div class="categorias">
                    ...
                    <a href="#" data-categoria="tecnologia-y-computadores">Tecnología y Computadores <i
                            class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="libros">Libros <i class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="ropa-y-accesorios">Ropa y Accesorios <i
                            class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="hogar-y-cocina">Hogar y Cocina <i
                            class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="juegos-y-juguetes">Juegos y Juguetes <i
                            class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="salud-y-belleza">Salud y Belleza <i
                            class="fa-solid fa-angle-right"></i></a>
                    <a href="#" data-categoria="alimentos-y-bebidas">Alimentos y Bebidas <i
                            class="fa-solid fa-angle-right"></i></a>
                </div>
...
while($mostrar=mysqli_fetch_array($result)){
        ...
        <div class="anuncio">
            <img src="data:image/jpg;base64,<?php echo base64_encode($mostrar['imagen']) ?>" alt="Anuncio"
                class="anuncioimg" /></td>
