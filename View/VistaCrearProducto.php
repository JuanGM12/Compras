<?php
    ...
    include ('../Model/ProductoCrear.php');
    ...
    switch ($bot) {
        case 'Guardar':
            $objProducto = new ProductoCrear('', $producto, $descripcion, $precio, $cantidad, $idcategoria, $imagen);
            $objControlProducto = new ControlProducto($objProducto);
            $objControlProducto->guardar();
            break;
    
        /*case 'Consultar':
            $objAutor = new Autores($Cedula, $Nombre, $Apellido);
            $objControlAutores = new ControlAutores($objAutor);
            $objAutor = $objControlAutores->consultar();
            $Cedula = $objAutor->getCedula();
        ...
        case 'Modificar':
            $objAutor = new Autores($Cedula, $Nombre, $Apellido);
            $objControlAutores = new ControlAutores($objAutor);
            $objControlAutores->modificar();
            break;
    
        case 'Borrar':
            $objAutor = new Autores($Cedula, $Nombre, $Apellido);
            $objControlAutores = new ControlAutores($objAutor);
            $objControlAutores->borrar();
            break;
        default:
            break;*/
    }
...
<html lang="en">
  ...
  <nav class="menu" id="menu">
    ...
    <form action="#" method="POST" enctype="multipart/form-data">
        <input type="text" id='producto' name="producto" value="<?php echo $producto ?>" placeholder="Producto">
        <input type="text" id='descripcion' name="descripcion" value="<?php echo $descripcion ?>" placeholder="Descripcion">
        <input type="text" id='precio' name="precio" value="<?php echo $precio ?>" placeholder="Precio">
        <input type="text" id='cantidad' name="cantidad" value="<?php echo $cantidad ?>" placeholder="Cantidad">
        <input type="text" id='idcategoria' name="idcategoria" value="<?php echo $idcategoria ?>" placeholder="Categoria">
        <input type="file" id='imagen' name="imagen" value="<?php echo $imagen ?>" placeholder="Imagen">

        <input id = "btn" type="submit" value="Guardar" name="btn"/>
    </form>
